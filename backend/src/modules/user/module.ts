...
export const setupUserModule = (sctx: ServiceContext) => {
  ...
  router.post('/users', mdlFactory.auth, httpService.createAPI.bind(httpService));
  router.get('/users/:id', httpService.getDetailAPI.bind(httpService));
  router.get('/users', httpService.listAPI.bind(httpService));
  router.patch('/users/:id', mdlFactory.auth, httpService.updateAPI.bind(httpService));
  router.delete('/users/:id', mdlFactory.auth, httpService.deleteAPI.bind(httpService));
